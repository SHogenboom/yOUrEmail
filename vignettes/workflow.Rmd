...
* `outlook`: pass down the outlook environment achieved during succesfull authentication
...
#### ONE EMAIL ####
submission_info <- get_submission_info(submissions[[1]])

#### MULTIPLE EMAILS ####
multi_submission_info <-
    lapply(
      X = submissions,
      FUN = function(email) {
...
the number of emails that were processed (i.e., `nrow(multi_submission_info) == length(submissions)`).
...
1. Write tests for missing information in the emails.
